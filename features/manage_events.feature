Feature: Manage events
  ...
  Scenario: Adding new event without repetition
    ...
    Then a event should exist with description: "Рождение", start: "2012-09-14 14:55:00", routine: "off"
  ...
  Scenario: Adding new event with weekly repetition
    Given I am on the new event page
        ...
        And I press "Сохранить"
    Then a event "Свадьба" should exist with description: "Свадьба", start: "2012-07-05 10:05:00", routine: "week"
  ...
  Scenario: Adding new event with monthly repetition
    Given I am on the new event page
        ...
        And I press "Сохранить"
    Then a event "Смерть" should exist with description: "Смерть", start: "2018-01-20 17:55:00", routine: "month"
